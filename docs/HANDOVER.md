...
**Updated:** 2026-07-05 · **Branch:** `main` · **Status: curriculum + learning-experience polish pass both shipped and verified (112 backend / 37 frontend tests, all green). Next: push to GitHub, then deploy — see item 1 below.**
