...
barista (NVIDIA ASR → Llama → TTS), and Hangul handwriting checks (Nemotron-VL).
...
| `AZURE_SPEECH_KEY` / `AZURE_SPEECH_REGION` | backend | for pronunciation | Azure pronunciation assessment |
| `NVIDIA_API_KEY` | backend | for conversations/writing | ASR, Llama chat, TTS, vision |
